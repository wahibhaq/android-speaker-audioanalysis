...
void setParam(int argc, char** argv) {
   	...
   	//__android_log_print(ANDROID_LOG_ERROR, "STATUS", "svm-train.cpp setParam()");
   	LOGD("STATUS : svm-train.cpp setParam()");
...
{
   	//__android_log_print(ANDROID_LOG_ERROR, "STATUS", "svm-train.cpp svmtrain(1D Array)");
   	//LOGD("STATUS %s\n", "svm-train.cpp svmtrain(1D Array)");
   	LOGD("STATUS : svm-train.cpp svmtrain(1D Array)");
...
{
   	//__android_log_print(ANDROID_LOG_ERROR, "STATUS", "svm-train.cpp svmtrain(2D Array)");
   	//LOGD("STATUS %s\n", "svm-train.cpp svmtrain(2D Array)");
   	LOGD("STATUS : svm-train.cpp svmtrain(2D Array)");

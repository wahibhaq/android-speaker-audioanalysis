...
public class ActClassificationActivity extends Activity {
	...
	public static final String SD_FOLDER_PATH = "/Thesis/SVM/Mels/200krows"; //"/Thesis/SVM";
	...
	private void setDefault() {
		...
		//offline training = both options are true and onine training = both options are false or at least m_isOfflineTrain is false
		
		m_isNormalized = true; // use the given data directly //default was false //I am normalizing on my end so keep it false
		m_isOfflineTrain = true; //train the model on the phone //default was false //true means offline is yes
		
		m_fileTrMean = SD_PATH + SD_FOLDER_PATH + "/libsvm_data/mean_tr.csv"; //used when m_isNormalized = true
	...
	void train_csv() {
		...
		Log.i("STATUS", "ActClassificationActivity - train_csv() ");
	...
	private void predict_accuracy() {
		...
		Log.i(TAG, "Prediction Accuracy : " + Float.toString(accuracy));
	}

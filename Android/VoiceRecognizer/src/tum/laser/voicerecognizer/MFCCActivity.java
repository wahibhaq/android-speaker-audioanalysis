...
public class MFCCActivity extends Activity {
	...
	private void handleRecordingAudio()
	{
		...
		repeatRecordThread = new Thread(repeatRecordRunnable);
		repeatRecordThread.start();
	}
	*/
	...
	private void monitorBatteryUsage()
	{
          ...
          appendToFile(String.valueOf(batteryLevel) + " " + getFormattedTimeStamp());
	}
...
/*	private void storeAudioStream() {
	...
	*/
	...
	/**
	 * Takes the final compiled arraylist of mfcc features and stores in csv in a loop.
	 * 
	 * @param featuresByFrameByWindow
	 * @param filename
	 */
	public void audioFeatures2csv(ArrayList<LinkedList<ArrayList<double[]>>> csvInput) {
		...
		try
		{
			 File direct = new File(SD_PATH + SD_FOLDER_PATH_CSV);
	...
	/**
	 * To add data to battery stats
	 * 
	 * @param filename
	 * @param dataToAppend
	 */
	private void appendToFile(String dataToAppend)
	{
		
//		 ///File file = new File(Environment.getExternalStorageDirectory(), filename);
//		 File direct = new File(SD_PATH + SD_FOLDER_PATH_CSV);
//		 File file = new File(SD_PATH + SD_FOLDER_PATH_CSV + File.separator + batteryFileName );
//
//
//	     if(!direct.exists())
//	     {
...
//	     
//		if(!file.exists())
//			file = new File(SD_PATH + SD_FOLDER_PATH_CSV + File.separator + batteryFileName);
//		
	     ...
	     if (sdLogsStorageDir.exists()) {
	    	 ...
	    	 showToast("Battery File doesn't exist !");
